...
def handle_player_choice():
    ...
    playXButton = pygame.Rect((width / 8), (height / 2), width / 4, 50)
    playOButton = pygame.Rect(5 * (width / 8), (height / 2), width / 4, 50)
    draw_button("Play as X", playXButton, mediumFont, black, white)
    draw_button("Play as O", playOButton, mediumFont, black, white)
...
def draw_board(board):
    """Draw the Tic-Tac-Toe board and current moves."""
    tile_size = 80
...
def main():
    ...
    while True:
        ...
        if user is None:
            ...
            if game_over:
                winner = ttt.winner(board)
                title = f"Game Over: {'Tie' if winner is None else f'{winner} wins'}."
            elif user == player:
                title = f"Play as {user}"
            else:
            ...
            if game_over:
                againButton = pygame.Rect(width / 3, height - 65, width / 3, 50)
                draw_button("Play Again", againButton, mediumFont, black, white)
